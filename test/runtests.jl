...
# !!! Main.UserApp is configured as an alias for Main.Sim and you might encounter it in some tests
using Main.Sim, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Sim tests" begin
  @includetests ARGS
end
